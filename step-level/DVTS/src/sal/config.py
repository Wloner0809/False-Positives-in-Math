...
@dataclass
class Config:
    approach: Literal["beam_search", "dvts"] = "dvts"

    # Model Related Options
    model_path: str = "/home/v-wangyu1/model/Llama-3.2-3B-Instruct"
    policy_model_name: str = "Llama-3.2-3B-Instruct"
    reward_model_path: str = "/home/v-wangyu1/model/Skywork-o1-Open-PRM-Qwen-2.5-7B"
