...
from sal.llm_service.base_model_worker import BaseModelWorker
        ...
        async for request_output in results_generator:
            ...
            ret = {
                "gen_text": (
                    ...
                    else [output.text for output in request_output.outputs]
                ),
                "stop_reason": (
                    request_output.outputs[0].stop_reason
                    if len(request_output.outputs) == 1
                    else [output.stop_reason for output in request_output.outputs]
                ),
                "finish_reason": (
