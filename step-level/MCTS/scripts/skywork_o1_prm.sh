...
# tmux send-keys "cd /scratch/amlt_code/MCTS" Enter
# tmux new-window -n reward_model_worker
# tmux send-keys "cd /scratch/amlt_code/MCTS" Enter
# tmux send-keys "export PATH=/home/aiscuser/.local/bin" Enter
# tmux send-keys "CUDA_VISIBLE_DEVICES=6,7 vllm serve /mnt/default/Inference-Scaling/Reward_Model/Skywork-o1-Open-PRM-Qwen-2.5-7B \
#     --host 0.0.0.0 \
#     --port 8081 \
