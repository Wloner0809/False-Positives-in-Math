...
class Pooler(nn.Module):
    ...
    def forward(
        ...
        if self.pooling_type is PoolingType.CLS:
            ...
            pooled_data = (
                cumsum[end_indices - 1]
                - cumsum[start_indices]
                + hidden_states[start_indices]
...
class Qwen2ForPrmModel(nn.Module, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self._pooler = Pooler.from_config_with_defaults(
            pooler_config, pooling_type=PoolingType.ALL, normalize=False, softmax=False
        )
...
def register():
    ...
    if "Qwen2ForPrmModel" not in ModelRegistry.get_supported_archs():
        ModelRegistry.register_model(
            "Qwen2ForPrmModel", "vllm_add_dummy_model.prm_model:Qwen2ForPrmModel"
        )
