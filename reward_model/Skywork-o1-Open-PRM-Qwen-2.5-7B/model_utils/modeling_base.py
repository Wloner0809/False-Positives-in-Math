...
if is_transformers_greater_than("4.33.0"):
    ...
    from transformers.deepspeed import is_deepspeed_zero3_enabled  # type: ignore
...
class PreTrainedModelWrapper(nn.Module):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        if kwargs is not None:
            ...
            peft_config = None  # noqa: F841
            is_trainable = False  # noqa: F841
            trl_model_args = {}
            pretrained_kwargs = {}
            peft_quantization_kwargs = {}  # noqa: F841
            token = None
        ...
        if isinstance(pretrained_model_name_or_path, str):
            remote_adapter_config = None  # noqa: F841
            local_adapter_present = os.path.exists(  # noqa: F841
