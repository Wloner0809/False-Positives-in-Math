...
def get_llama_test_set(test_set_path, tokenizer, max_tokens=4096):
    ...
    for test_data in tqdm(test_set, desc="Process Data", total=len(test_set)):
        ...
        # problem = (
        #     test_data["prompt"]
        #     .split("user<|end_header_id|>\n\n")[1]
        #     .split("<|eot_id|>")[0]
        # )
        #! new prompt for llama3.1&3.2 cot
        problem = test_data["prompt"].split("Problem: ")[1].split("<|eot_id|>")[0]
...
if __name__ == "__main__":
    ...
    # -----------------------------------------------------
    test_list, original_prompt, original_responses = get_llama_test_set(
