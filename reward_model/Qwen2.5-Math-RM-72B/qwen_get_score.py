...
class ScriptArguments:
    ...
    test_set_path: Optional[str] = field(
        default="/mnt/default/Inference-Scaling/sample/Qwen/Qwen2.5_Math_7B_Instruct-math500_256answers_per_question.jsonl"
    )
    output_path: Optional[str] = field(
        default="/mnt/default/Inference-Scaling/sample/Qwen-with-scores/Qwen2.5-MATH-RM-72B/Qwen2.5_Math_7B_Instruct-math500_256answers_per_question-with_scores.jsonl",
    )
...
if __name__ == "__main__":
    ...
    # -----------------------------------------------------
    test_list, original_prompt, original_responses = get_qwen_test_set(
    ...
    if script_args.batch_size != -1:
        ...
        scores = []
        for single_test_list in tqdm(test_list, desc="Scoring", total=len(test_list)):
            single_scores = []
            responses = client.embeddings.create(
                input=single_test_list,
                model=model,
